  ...
  <div class="statistics-div">
    ...
    <a-card title="请选择报表类型" size="small">
      <div class="report-type-div">
        ...
        <a-checkbox>按照执行时间统计</a-checkbox>
        <a-checkbox>按照所属分组统计</a-checkbox>
        <a-checkbox>按照任务时效统计</a-checkbox>
        <a-checkbox>按照执行环境统计</a-checkbox>
        <a-checkbox>按照设备统计</a-checkbox>
      </div>
    </a-card>
    <!-- 图表 -->
    <div class="chart-div">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const onClickOfAction = (event) => {
        ...
        switch (event) {
          case "返回":
            instance.proxy.$router.push("/index/task/list");
            break;
          case "保存":
            break;
          default:
